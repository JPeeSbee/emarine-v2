                    ...
                    <tbody>
                        @foreach ($users as $key => $user)
                            <tr wire.key="{{$user->id}}" class="@if($key%2==0) bg-gray-200 dark:bg-gray-600 @else bg-white dark:bg-gray-800 @endif border-b dark:border-gray-700 border-gray-200">
                                ...
                                <td>
                                    <button type="button" class="focus:outline-none text-white bg-teal-700 hover:bg-teal-800 focus:ring-4 focus:ring-teal-300 font-medium rounded-lg text-sm dark:bg-teal-600 dark:hover:bg-teal-700 dark:focus:ring-red-900" title="Reset Password">
