    ...
    <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
        ...
        <form class="max-w-sm md:max-w-lg mx-auto my-12" wire:submit='store'>
            <div class="grid md:grid-cols-2 md:gap-6">
                ...
                <div class="relative z-0 w-full mb-5 p-2 group">
                    <input wire:model='name' type="name" name="name" id="name" value="{{old('name')}}" class="block py-2.5 px-2 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=""/>
                ...
                <div class="relative z-0 w-full mb-5 p-2 group">
                    <input wire:model='rate_percent' type="rate_percent" name="rate_percent" id="rate_percent" value="{{old('rate_percent')}}" class="block py-2.5 px-2 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=""/>
