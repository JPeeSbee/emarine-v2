            ...
            @else
                <div class="relative grid grid-cols-4 m-2">
                    ...
                    <div class="col-span-2 col-start-3 flex justify-end space-x-2">
                        <button type="button" class="focus:outline-none text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm dark:focus:ring-green-900" title="Create {{$title}}">
