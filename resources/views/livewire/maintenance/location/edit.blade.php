    ...
    <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
        ...
        <form class="max-w-xs md:max-w-lg mx-auto my-12" wire:submit='update'>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input wire:model='name' type="text" name="name" id="name" value="{{ old('name', $location->name) }}" class="block py-2.5 px-2 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" />
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input wire:model='address' type="text" name="address" id="address" value="{{ old('address', $location->address) }}" class="block py-2.5 px-2 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" />
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input wire:model='lgt_tax_rate' type="number" step="any" name="lgt_tax_rate" id="lgt_tax_rate" value="{{ old('lgt_tax_rate', $location->lgt_tax_rate) }}" class="block py-2.5 px-2 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" />
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input wire:model='email_recepient' type="text" name="email_recepient" id="email_recepient" value="{{ old('email_recepient', $location->email_recepient) }}" class="block py-2.5 px-2 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" />
