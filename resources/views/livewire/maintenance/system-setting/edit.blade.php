    ...
    <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
        ...
        <form class="max-w-xs md:max-w-lg mx-auto my-12" wire:submit='update'>
            ...
            <div class="grid md:grid-cols-2 md:gap-6">
                <div class="relative z-0 w-full mb-5 group">
                    <input wire:model='name' type="text" name="name" id="name" value="{{ old('name', $setting->name) }}" class="block py-2.5 px-2 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" />
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input wire:model='value' type="text" name="value" id="value" value="{{ old('value', $setting->value) }}" class="block py-2.5 px-2 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" />
